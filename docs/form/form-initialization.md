...
| **plugins**  | Enable additional functionalities using external libraries for validation.                    | [Validation Plugins](../validation/plugins.md) |
| **bindings** | Define how the fields properties are passed to the input components.                          | [Props Bindings](../bindings/README.md)        |
| **extra**    | Inject extra objects to be accesse as `form.extra`                                            | -                                              |
