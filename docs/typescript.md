...
mobx-formkit ships with first-class TypeScript support, providing type inference for form fields, autocomplete for field properties, and nested path autocomplete for the `$()` selector.
...
```typescript
import { Form, PathsOf } from 'mobx-formkit';
