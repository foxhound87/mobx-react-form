...
|---|---|---|---|---|
| **clear()** | - | - | Clear the Form to empty values. | [help](../actions/shared.html#clear--reset-form-or-fields) |
| **reset()** | - | - | Reset the Form to default values. | [help](../actions/shared.html#clear--reset-form-or-fields) |
...
| **showErrors(bool)** | bool | - | Show or Hide Field Error Messages. | [help](../actions/form.html#validation-errors) |
...
| **reduce(callback, acc)** | (function) | - | Reduce Nested Fields | [help](../actions/shared.html#reduce) |
...
| **hasNestedFields**    | - | boolean | Check if the form has Nested Fields. | [help](../fields/) |
| **hasIncrementalKeys** | - | boolean | Check if the nested fields have incremental keys. | - |

> `hasNestedFields` and `hasIncrementalKeys` are computed properties (getters), not methods.
