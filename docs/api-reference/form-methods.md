...
| **validate(path)** | (object) | promise | Takes a an object in input with `related` or `showErrors` options. Check if the field and nested fields are valid and return a promise. | [help](../actions/form.md#validate-the-form) |
