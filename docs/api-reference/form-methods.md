...
| **move(fromIndex, toIndex)** | (number, number) | void | Move an array field item from one index to another. Preserves bindings and validation. | [help](../actions/shared.html) |
