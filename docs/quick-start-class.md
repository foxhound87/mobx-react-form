...
> See [Validation Plugins](validation/plugins.md) for all supported validators: **VJF** (vanilla functions), **DVR** (declarative rules), **AJV** (JSON Schema), **YUP**, **JOI**, **ZOD**, **VALIBOT**, **VINEJS**.
