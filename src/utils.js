...
const props = ['value', 'initial', 'default', 'label', 'placeholder', 'disabled', 'related', 'bindings', 'type', 'error'];
const iprops = ['values', 'initials', 'defaults', 'labels', 'placeholders', 'disabled', 'related', 'bindings', 'types'];
